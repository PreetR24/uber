...
const CaptainLogin = () => {
    ...
    const handleGoogleLogin = async (credentialResponse) => {
        try {
            ...
            const response = await axios.post(`${import.meta.env.VITE_BASE_URL}/captains/google-login`, { email });
            
            if (response.data.captainExists) {
                ...
                setAlertType("error");
                setAlertMessage("No Captain found with this email.");
            }
        } catch (err) {
            setAlertType("error");
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 flex flex-col justify-between p-4 sm:p-6 md:p-8 lg:max-w-md lg:mx-auto">
            ...
            <div className="mb-8">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Welcome back Captain</h2>
                ...
                <div className="space-y-1">
                    ...
                    <div className="space-y-1 relative">
                                            <div className="flex justify-between items-center">
                                                ...
                                                <Link to="/captain-login/forgot-psd" className="text-sm text-blue-600 hover:text-blue-800 font-medium">
                                                    Forgot password?
                                                </Link>
                                            </div>
                ...
                <div className="mt-6 text-center text-gray-600">
                                    New here? <Link to="/captain-signup" className="text-blue-600 font-medium hover:text-blue-800 transition-colors">Create an account</Link>
                                </div>
            </div>
            <div className="mt-8 w-full max-w-sm mx-auto pb-4">
                            <Link
                                to="/login"
                                className="flex items-center justify-center w-full bg-red-900 text-white font-medium py-3 px-4 rounded-lg hover:bg-red-900 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2"
                            >
