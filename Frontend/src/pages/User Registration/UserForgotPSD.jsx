...
const UserForgotPSD = () => {
    ...
    const SendOTPHandler = async (e) => {
        ...
        setIsLoading(true);
        try {
            await axios.post(`${import.meta.env.VITE_BASE_URL}/users/login/send-otp`,{ email }, {withCredentials: true });
            setOtpSent(true);
    ...
    const handleResendOTP = async () => {
        ...
        try {
            await axios.post(`${import.meta.env.VITE_BASE_URL}/users/login/send-otp`, 
                { email }, 
    ...
    const handleCompleteRegistration = async (e) => {
        ...
        setIsLoading(true);
        try {
            const response = await axios.post(`${import.meta.env.VITE_BASE_URL}/users/login/set-psd`, {
                email,
                password,
            },
            { withCredentials: true }
