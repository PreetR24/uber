...
const VehiclePanel = (props) => {
    return (
        <div>
            ...
            }} className='flex border-2 hover:border-black  mb-2 rounded-xl w-full p-3  items-center justify-between'>
            ...
            <div onClick={() => {
                ...
                <h2 className='text-lg font-semibold'>₹{props.fare.motorbike}</h2>
            </div>
            <div onClick={() => {
                props.setConfirmRidePanel(true)
